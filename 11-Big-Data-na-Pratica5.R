setwd("A:/Projetos/BigDataAnalyticsComReMAzureLearning/Cap07/AnaliseSeriesTemporaisMercadoFinanceiroR")
...
# Plot do fechamento:
plot(PETR4.SA.Close, main = "Fechamento Diário Ações Petrobras", col = "red",
     xlab = "Data", yLab = "Preço", major.ticks = "months", minor.ticks = FALSE)

# Adicionando as bandas de bollinger ao gráfico, com média de 20 períodos e 2 desvios
# Bollinger Band
# Como o desvio padrão é uma medida de volatilidade,
# Bollinger Bands ajustam-se às condições de mercado. Mercados mais voláteis possuem
# as bandas mais distantes, enquanto mercados menos voláteis possuem as bancas mais próximas
?addBBands
addBBands(n = 20, sd = 2)

# Adicionando o indicador ADX, média 11 do tipo exponencial
?addADX
addADX(n = 11, mType = "EMA")
...
plot(PETR4.SA.ret, main = "Fechamento Diário das Ações da Petrobras", col="red",
     xlab = "Data", ylab = "Retorno", major.ticks = "months", minor.ticks = FALSE)
